                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name"
                                   value="{{ ($old = old('name'))?$old:$resource->name }}" required>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="controller"
                                   value="{{ ($old = old('controller'))?$old:$resource->controller }}" required>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="action"
                                   value="{{ ($old = old('action'))?$old:$resource->action }}" required>
                            <small class="form-text text-muted">Example:
                                App\Http\Controllers\ResourceController@create.</small>
                        </div>
                    </div>
